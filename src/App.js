...
function App() {
  ...
  const base_url = "74.235.226.249:5002/";
  ...
  useEffect(()=>{
    ...
    if(token!='undefined'){
      ...
      // save visitor token 
      const url = base_url+'generate_token/?browser_i='+browserId;
  ...
  return (
    <div className="App">
      ...
      <BrowserRouter >
        ...
        {loginVisible&&<LoginRegister closeFormsHandler={closeLoginForm}/>}
        <Main />
      </div>} />
          <Route path='/user' element={<UserProfilePage setActiveProduct={setActiveProduct}/>}/>
          <Route path="/products" element ={<ProductDescription productId={activeProduct}/>} />
